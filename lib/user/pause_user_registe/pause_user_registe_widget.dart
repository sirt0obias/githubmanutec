...
import 'pause_user_registe_model.dart';
export 'pause_user_registe_model.dart';

class PauseUserRegisteWidget extends StatefulWidget {
  const PauseUserRegisteWidget({super.key});

  @override
  _PauseUserRegisteWidgetState createState() => _PauseUserRegisteWidgetState();
}

class _PauseUserRegisteWidgetState extends State<PauseUserRegisteWidget> {
  late PauseUserRegisteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PauseUserRegisteModel());
                                ...
                                onPressed: () async {
                                  ...
                                  if (confirmDialogResponse) {
                                    ...
                                    if (_model.passwordFieldController.text !=
                                        _model
                                            .passwordFieldConfController.text) {
                                    ...
                                    await UsuariosTable().insert({
                                      ...
                                      'email_usua':
                                          _model.emailFieldController.text,
                                      'cpf_usua':
                                          _model.cpfFieldController.text,
                                      'cnpj_usua':
                                          _model.cnpjFieldController.text,
                                    });
                                  } else {
                                    return;
                                  }
