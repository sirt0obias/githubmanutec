                  ...
                  children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          Align(
                            ...
                            child: FutureBuilder<List<NotasRow>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<NotasRow> containerNotasRowList =
                                    snapshot.data!;
                                return Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          children: [
                                            Text(
                                              'Nº - ${containerNotasRowList.length.toString()}/${dateTimeFormat('y', getCurrentTimestamp)}',
                                              style:
                    ...
                    FutureBuilder<List<ClientesRow>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<ClientesRow> dropDownClientesRowList =
                            snapshot.data!;
                        return FlutterFlowDropDown<int>(
                          controller: _model.dropDownValueController1 ??=
                              FormFieldController<int>(null),
                          options: List<int>.from(dropDownClientesRowList
                              .map((e) => e.id)
                              .toList()),
                          optionLabels: dropDownClientesRowList
                              .map((e) => e.cliente)
                              .withoutNulls
                              .toList(),
                          onChanged: (val) =>
                          ...
                          hintText: 'Seleção de Clientes',
                          searchHintText: 'Pesquise aqui...',
                          icon: Icon(
                    ...
                    FutureBuilder<List<UsuariosRow>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<UsuariosRow> dropDownUsuariosRowList =
                            snapshot.data!;
